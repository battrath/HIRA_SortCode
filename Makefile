OBJECTS = det.o hira.o histo_sort.o histo_read.o caen.o calibrate.o TDC1190.o elist.o doppler.o solution.o ZApar.o pid.o einstein.o newton.o correl2.o  loss2.o losses.o S800.o fiber.o XYmon.o ringCounter.o ceasar.o readBeam.o readMass.o telescope.o
