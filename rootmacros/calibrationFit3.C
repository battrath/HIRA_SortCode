{
  ...
  TCanvas canvas("calibrationFit3","");
...
" signal 2plus1 peak2 = " << sum_peak2_2plus1_gate << 
  ...
  TBox box_b23(4.6,0.,5.6,600);
  box_b23.SetFillColor(3);
  box_b23.SetFillStyle(3001);
  box_b23.Draw("same");


  TBox box_justabove(7,0.,8.,600);
  box_justabove.SetFillColor(6);
  box_justabove.SetFillStyle(3001);
  box_justabove.Draw("same");



  TBox box_2plus2(6.23,0.,6.58,1200);
  box_2plus2.SetFillColor(4);
  box_2plus2.SetFillStyle(3001);
  box_2plus2.Draw("same");
